 ...
 class SimpleInappDialogView: UIView {
    ...
    // MARK: - View setup
	 ...
	 private func setupViews() {
		...
		labelsStackView.addArrangedSubviews(titleLabel, messageLabel, labelButtonSpacer, buttonsContainer)
		 
        componentContainer.addSubview(labelsStackView)

        fullStackView.addArrangedSubviews(imageView, componentContainer)

        addSubviews(fullStackView, dismissButton)
        ...
        labelsStackView.anchorToSuperview(top: 16, leading: 15, trailing: 20, bottom: 16)
