...
class InAppMessage{
    ...
    private struct Keys {
        ...
        static let ignoreTouchpointPolicy = "ignoreTouchpointPolicy"
    }
    ...
    let ignoreTouchpointPolicy: Bool
    ...
    init?(withDictionary dictionary: [String: Any]) {
        ...
        ignoreTouchpointPolicy = dictionary[Keys.ignoreTouchpointPolicy] as? Bool ?? false
