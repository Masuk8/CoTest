...
struct MessageTriggerMapper {
    ...
    private enum TriggerType: String {
        ...
        case extendedOneOfEventTrigger = "ExtendedOneOfEventTrigger"
    }
    ...
    static func map(withDictionary dictionary: [String: Any]) -> InAppMessageTrigger? {
        ...
        var type: InAppMessageTrigger?
          ...
          case TriggerType.noEventTrigger.rawValue:
              type = NoEventTrigger()
          case TriggerType.extendedOneOfEventTrigger.rawValue:
            type = ExtendedOneOfEventTrigger(withDictionary: dictionary)
          default:
              type = nil
          }
        return type
